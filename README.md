...
Ghi chú:
- Giao diện đã được chuyển sang CSS/JS thuần (không dùng Bootstrap).
- Nếu ảnh không hiện, kiểm tra Console (F12) để xem lỗi mạng hoặc url ảnh.

Tác giả: Nguyễn Đức Quang - Lập trình Web - Sáng thứ 3.
